...
external interface LocalForageSerializer {
    ...
    fun <T> serialize(value: ArrayBuffer, callback: (value: String, error: Any) -> Unit)
    fun <T> serialize(value: Blob, callback: (value: String, error: Any) -> Unit)
    fun <T> deserialize(value: String): dynamic /* T | ArrayBuffer | Blob */
